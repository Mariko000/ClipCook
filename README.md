# 🍳 ClipCook
### **「計量の壁」を解決する 日・英・米対応レシピSNS**

ClipCookは、海外レシピ特有の単位（cup, oz, lb等）や、地域による容量差（US/UK/JP）を誰でも正確に調理できるようにサポートするレシピ管理・SNSプラットフォームです。
...
* ![Image](https://github.com/user-attachments/assets/ca6a8321-7ecc-441f-a003-bc3b5e3a22ee)
* **材料連動型・自動倍率計算**: 1つの材料を変えると、レシピ全体の分量を自動調整（例: 1人前 ↔ 4人前）。
![Image](https://github.com/user-attachments/assets/94b9203c-43de-485a-8755-3d4c0ff58fa5)

### **2. Timeline（TikTok風SNS）**
* **スワイプUI**: 写真付きレシピを直感的なアルバムへ。
* **シームレス連携**: タイムラインからワンタップでレシピへ移行可能。
* **ソーシャル機能**: フォロー、チャット、ブックマーク機能を搭載。
